...
$(document).ready(function () {
    $(
        ".comment-form input[title], .comment-form textarea, .forms textarea"
    ).each(function () {
        if ($(this).val() === "") {
...
$(document).ready(function () {
    if (
        (!window.chrome && typeof document.webkitIsFullScreen != "undefined") ||
    ...
    var link =
        'a:not([target="_blank"]):not([href*=#]):not([href^=mailto]):not(.fancybox-media):not(.btn.responsive-menu)';
